...
- For now, evaluate in English when you need strict behavior, or extend
  indicator patterns in `normcore-py/src/normcore/normative/statement_extractor.py` and
  `normcore-py/src/normcore/normative/modality_detector.py` for your target language.
...
Implementation: `normcore-py/src/normcore/evaluator.py`

Normative pipeline: `normcore-py/src/normcore/normative/`
...
scripts/python/evaluate_history.sh \
...
- `normcore-py/src/normcore/evaluator.py`: orchestration + public entrypoint
- `normcore-py/src/normcore/models/`: judgment + message models
- `normcore-py/src/normcore/normative/`: modality, grounding, licensing, axioms
- `normcore-py/src/normcore/cli.py`: command-line interface (`normcore`)
