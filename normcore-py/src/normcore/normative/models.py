...
class GroundSet:
    ...
    def get_scope_strength(self, scope: Scope) -> str | None:
        """
    ...
    def has_strong_in_scope(self, scope: Scope) -> bool:
        ...
        """
        return any(k.scope == scope and k.strength == "strong" for k in self.nodes)

    # ========================================================================
    # Link resolution methods (NEW v0.3.1 - StatementGroundLinks support)
    # ========================================================================

    def resolve_ground(self, ground_id: str) -> KnowledgeNode | None:
        """
...
class ValidationResult:
    ...
    feedback_hint: str | None = None  # What to tell agent to fix
